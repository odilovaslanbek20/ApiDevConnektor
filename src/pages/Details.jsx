...
export default function PostsDetails() {
	...
	const { data: post, loading, error } = useGetData(`/posts/${id}`)

	if (loading) {
		return (
			<div className='mt-[100px] flex items-center justify-center flex-col gap-[20px] text-[#17a2b8] absolute top-[30%] left-[45%] max-[440px]:left-[40%]'>
